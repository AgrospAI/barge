...
| ocean-contracts     |                    | v2.3.0                            | 172.15.0.14     |               |
| Ocean-Node          |                    | latest                            | 172.15.0.5      | 8000 -> 8000, 8001 -> 8001  |
| Elasticsearch       |  Ocean-node        | 8.5.1                             | 172.15.0.6      |               |
| Typesense           |  Ocean-node        | 0.25.1                            | 172.15.0.20     | 8108 -> 8108  |
| Ipfs                |                    | ipfs/go-ipfs:v0.4.23              | 172.15.0.16     | 5001 -> 5001  |
...
| Option                     | Description                                                                                     |
| -------------------------- | ----------------------------------------------------------------------------------------------- |
| `--no-node`                | Start up Ocean without the `Node` Building Block.                                               |
...
| `--with-dashboard`         | Start up Ocean with the `dashboard` Building Block.                                             |
...
| --------------- | ------------- | -------------------- | --------------------- | ----------------------------------------------------- |
| `node`          | `8000:8001`   | http://node:8001     | http://localhost:8001 | [Node](https://github.com/oceanprotocol/ocean-node) |
